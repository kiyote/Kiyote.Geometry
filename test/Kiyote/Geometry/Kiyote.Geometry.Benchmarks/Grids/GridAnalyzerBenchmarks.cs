namespace Kiyote.Geometry.Grids.Benchmarks;
...
public class GridAnalyzerBenchmarks {

	private const int Size = 100;

	private readonly IGridAnalyzer _analyzer;
	private readonly IGrid<char> _grid;
	private readonly WallPassabilityStrategy _isPassable;

	public GridAnalyzerBenchmarks() {
		_analyzer = new GridAnalyzer();
		_grid = CreateGrid();
